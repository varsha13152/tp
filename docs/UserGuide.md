...
| **Tag**       | `tag INDEX t/TAG` <br> e.g., `tag 1 t/friend` or <br/> `tag INDEX b/PROPERTY from/YYYY-MM-DD to/YYYY-MM-DD` <br> e.g., `tag 1 b/Hotel from/2025-10-10 to/2025-10-11`                                                                                                                                              |
| **Untag**     | `untag INDEX t/TAG` <br> e.g., `untag 1 t/TEST` or <br/> `untag INDEX b/PROPERTY from/START_DATE to/END_DATE` <br> e.g., `untag 1 b/Hotel from/2025-10-10 to/2025-10-11`                                                                                                                                                     |
