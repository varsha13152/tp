...
|--------------------|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `NAME`             | `n/`      | Specifies the name of a visitor. <br><br> **Requirements:** <ul><li>Names can take any values not containing '$'.</li><li>Names cannot exceed 170 characters.</li><li>Names with only whitespace are not allowed.</li><li>Names with only whitespace are not allowed.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
i.e. To add a contact with the name "murthu a/p", use the command `add n/murthu $a/p [...]`.
...
i.e. To change the name of the first contact in the list toe "murthu a/p", use the command `edit 1 n/murthu $a/p [...]`.
