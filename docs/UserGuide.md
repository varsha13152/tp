...
Allows users to search for a contact by name, phone, address, email, tag, memo, booking date, or booking property.
...
| `b/`    | Booking Date    | Legacy version of `bd/` (works identically) | `find b/2025-01-01` |
