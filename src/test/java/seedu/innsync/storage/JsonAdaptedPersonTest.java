...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_BOOKINGTAG = "house";
    ...
    private static final List<JsonAdaptedBookingTag> VALID_BOOKINGTAG = BENSON.getBookingTags().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_BOOKINGTAG, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        INVALID_ADDRESS, VALID_BOOKINGTAG, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_BOOKINGTAG, VALID_TAGS);
    ...
    public void toModelType_invalidBookingTags_throwsIllegalValueException() {
        List<JsonAdaptedBookingTag> invalidBookingTags = new ArrayList<>(VALID_BOOKINGTAG);
        invalidBookingTags.add(new JsonAdaptedBookingTag(INVALID_BOOKINGTAG));
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, invalidBookingTags, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_BOOKINGTAG, invalidTags);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
